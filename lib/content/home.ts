...
export const hero = {
  ...
  sub: "iSuite AI brings WhatsApp, Instagram, Facebook and website enquiries into one inbox - where an AI sales assistant replies in your customer's language, qualifies the lead, books appointments and follows up. And every one becomes a deal on your sales board, with an owner and a next step.",
